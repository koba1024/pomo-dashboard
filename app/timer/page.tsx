      ...
      <div className="flex min-h-screen flex-col md:flex-row">
        ...
        <div className="flex-1 bg-gray-100">
          <header className="border-b border-gray-200 bg-white px-6 py-4">
            <h1 className="text-3xl font-bold">ポモドーロタイマー</h1>
          </header>
          ...
          <main className="p-4 sm:p-6">
            ...
            <TargetSelectionSection
              ...
              selectedTargetIdByType={state.ui.selectedTargetIdByType}
            ...
            {state.ui.mode === "pomodoro" ? (
              <PomodoroSettingsSection
                ...
                onAddWorkMinutes={handleOpenAddWorkMinutesDialog}
                onAddBreakMinutes={handleOpenAddBreakMinutesDialog}
              />
            ) : (
